    ...
    <form id="form1" runat="server">
        <div class="mainDiv">
            ...
            <div class="imgDiv">
                ...
                <div class="submit_imgDiv" id="submit_imgDiv_view2"><img id="submit_imgDiv_view2_img" src="" /></div>
                <div class="submit_imgDiv" id="submit_imgDiv_view3"><img id="submit_imgDiv_view3_img" src="" /></div>
